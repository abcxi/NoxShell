...
> 截图使用本地演示会话生成，不包含真实服务器凭据。当前版本：`v0.2.60`。
...
| 系统 | 安装包 | 适用设备 |
| --- | --- | --- |
| macOS | [Apple Silicon DMG](https://github.com/abcxi/NoxShell/releases/download/v0.2.60/NoxShell-v0.2.60-macOS-arm64.dmg) | M1、M2、M3、M4 等 Apple 芯片 Mac |
| macOS | [Intel DMG](https://github.com/abcxi/NoxShell/releases/download/v0.2.60/NoxShell-v0.2.60-macOS-x86_64.dmg) | Intel 芯片 Mac |
| Windows | [安装版 EXE](https://github.com/abcxi/NoxShell/releases/download/v0.2.60/NoxShell-v0.2.60-Windows-x64.exe) | 64 位 Windows，推荐使用 |
| Windows | [便携版 ZIP](https://github.com/abcxi/NoxShell/releases/download/v0.2.60/NoxShell-v0.2.60-Windows-x64.zip) | 64 位 Windows，解压即用 |
| 校验文件 | [SHA256SUMS.txt](https://github.com/abcxi/NoxShell/releases/download/v0.2.60/SHA256SUMS.txt) | 验证下载文件完整性 |
